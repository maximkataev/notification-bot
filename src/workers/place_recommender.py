...
_PLACE_KINDS = {
    "tbilisi": [
        "атмосферное кафе или кофейня",
        "хороший ресторан (грузинская или интересная кухня)",
...
- Известное и работающее место, которое легко найти на картах.
- Укажи район/местоположение.
- Дай короткое (1-2 предложения) живое описание на русском: чем место интересно и почему стоит сходить.{avoid_block}
