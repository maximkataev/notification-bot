...
🔴 ОБЯЗАТЕЛЬНОЕ РАСПРЕДЕЛЕНИЕ - РОВНО 5 НОВОСТЕЙ:
...
📍 НОВОСТЬ #3 — СПОРТ:
   ✅ ВКЛЮЧАЕТ: футбол (особенно Лига 1, Премьер-лига, Ла Лига), хоккей, теннис, легкая атлетика, Олимпиада, чемпионаты
   ❌ НЕ ВКЛЮЧАЕТ: баскетбол, бейсбол, Формула-1, скалолазание, киберспорт
...
- ВСЕГДА возвращай ровно 5 новостей!

✅ ЕСЛИ НЕТ ПОДХОДЯЩЕЙ НОВОСТИ в категории:
- Спорт отсутствует → выбираю активные события/соревнования (не киберспорт)
- Технологии отсутствуют → выбираю бизнес-инновации или стартапы
- Культура отсутствует → выбираю позитивные новости или науку
...
6. Я возвращаю ответ JSON массивом ровно 5 новостей в правильном порядке
...
🔴 АБСОЛЮТНЫЕ ПРАВИЛА:
- ТОЧНО 5 новостей (не больше, не меньше!)
- ПО ОДНОЙ в каждой категории 3, 4, 5 (спорт, культура, технологии)
...
✅ ЕСЛИ КАТЕГОРИЯ ПУСТО:
- Спорт отсутствует → выбираю активные события (соревнования, турниры - но не киберспорт)
- Технологии отсутствуют → выбираю стартапы или бизнес-инновации
- Культура отсутствует → выбираю позитивные новости или науку
