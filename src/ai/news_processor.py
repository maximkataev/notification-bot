...
[
  ...
  {{"index": 18, "category": "sports", "summary": "Лионель Месси забил 50-й гол в этом сезоне за новый клуб", "description_ru": "Матч закончился со счётом 4:1 в пользу его команды. Месси набирает форму после перехода и показывает лучшие результаты."}}
]
