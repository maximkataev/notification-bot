    ...
    try:
        ...
        user_profile_section = (
            ...
            if custom_prompt
                ...
                "баскетбол, бейсбол, формулу-1, гонки, racing, машины, моду, кино, сериалы, документалки, знаменитостей и актёров, "
...
📍 НОВОСТЬ #6 — ДОБРЫЕ НОВОСТИ (ПОЗИТИВНЫЙ ВАЙБ):
   ✅ ВКЛЮЧАЕТ: истории про животных, волонтёрство, добрые дела, спасение животных, благотворительность, вдохновляющие истории, позитивные события в обществе
   ❌ НЕ ВКЛЮЧАЕТ: политику, экономику, спорт, технологии, кино, развлечение
...
6️⃣ ДОБРЫЕ НОВОСТИ (позитивные вайбы - животные, добрые дела, волонтёрство, вдохновляющие истории)
...
- 6️⃣ ДОБРЫЕ НОВОСТИ (животные, волонтёрство, добрые дела, благотворительность, вдохновляющие истории, НЕ спорт!)
